...
describe("CineJoy Testcases.", function() {
    ...
    const Production_URL = "https://creatics.org/";
      ...
      beforeEach(() => {        
        ...
        hitmakerPage.navigateToFilming();
      ...
      it("Validate Filming main page details added by the admin user" , () =>{
        cy.contains("Filming in Motion: Join the Creative Process On Set");
      ...
      it("Validate Polls, update and ask team anything functionality under filming" , () =>{
