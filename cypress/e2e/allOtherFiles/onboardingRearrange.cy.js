...
describe.skip("Verify Onboarding Flow Test Cases", () => {
  ...
  const Mobile_URL = "https://mobilej21.creatics.org/";
  ...
  it.only("Verify that the user completes the sign-up process, navigates to the profile page, and successfully submits the data.", () => {
